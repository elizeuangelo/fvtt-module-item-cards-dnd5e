...
// ============================================================================
export function card_default_options() {
	return {
...
export function card_generate_front(data, options) {
...
export function card_generate_back(data, options) {
...
export function card_pages_generate_html(card_data, options) {
...
export function card_pages_insert_into(card_data, container) {
